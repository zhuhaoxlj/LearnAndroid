...
private val LightColorPalette = LearnAndroidColors(
    bottomBar = white1,
    background = white2,
    listItem = white,
    divider = white3,
...
private val DarkColorPalette = LearnAndroidColors(
    bottomBar = black1,
    background = black2,
    listItem = black3,
    divider = black4,
...
private val NewYearColorPalette = LearnAndroidColors(
    bottomBar = red4,
    background = red5,
    listItem = red2,
    divider = red3,
...
private val LocalLearnAndroidColors = compositionLocalOf {
    LightColorPalette
}

object LearnAndroidTheme {
    val themeColors: LearnAndroidColors
        @Composable
        get() = LocalLearnAndroidColors.current
...
class LearnAndroidColors(
    ...
    var selectedIconColor: Color by mutableStateOf(bottomBar)
        private set
...
fun LearnAndroidTheme(
    theme: LearnAndroidTheme.Theme = LearnAndroidTheme.Theme.Light,
    content: @Composable() () -> Unit
) {
    val targetColors = when (theme) {
        LearnAndroidTheme.Theme.Light -> LightColorPalette
        LearnAndroidTheme.Theme.Dark -> DarkColorPalette
        LearnAndroidTheme.Theme.NewYear -> NewYearColorPalette
    }
    ...
    CompositionLocalProvider(LocalLearnAndroidColors provides colors) {
        MaterialTheme(
            shapes = shapes,
            content = content
        )
